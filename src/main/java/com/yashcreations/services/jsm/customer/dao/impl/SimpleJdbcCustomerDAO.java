package com.yashcreations.services.jsm.customer.dao.impl;
...
import com.yashcreations.services.jsm.customer.dao.model.CustomerParameterizedRowMapper;
...
public class SimpleJdbcCustomerDAO extends SimpleJdbcDaoSupport implements CustomerDAO {
	...
	public Customer getCustomer(String customerId) {
		...
		Customer customer = getSimpleJdbcTemplate().queryForObject(sql, new CustomerParameterizedRowMapper(), customerId);
	...
	public void insertBatchNamedParameter2(final List<Customer> customers) {
		...
		getSimpleJdbcTemplate().batchUpdate("INSERT INTO CUSTOMER (CUST_ID, NAME, AGE) VALUES (:custId, :name, :age)",
				params);
	...
	public Customer findByCustomerId(int custId) {
		...
		Customer customer = getSimpleJdbcTemplate().queryForObject(sql, new CustomerParameterizedRowMapper(), custId);
	...
	// query mutiple rows with ParameterizedBeanPropertyRowMapper
	// (Customer.class)
	public List<Customer> findAll() {

		String sql = "SELECT * FROM CUSTOMER";

		List<Customer> customers = getSimpleJdbcTemplate().query(sql,
